      ...
      <div className="sticky top-0 z-10 bg-surface border-b border-border px-6 py-4 flex items-center justify-between shadow-sm">
        ...
        <div className="flex gap-3">
          <Button 
            ...
            disabled={saving}
            className="bg-destructive/50 hover:bg-destructive text-white rounded-full px-6"
          >
      ...
      <div className="container mx-auto p-6 max-w-4xl">
        <div className="bg-surface rounded-2xl shadow-sm overflow-hidden">
          <div className="bg-surface-2 p-4 border-b border-border">
            ...
            <p className="text-xs text-muted-foreground mt-1">Atualize as informações do produto #{formData.id}</p>
          </div>
          <div className="p-6">
            <form id="produto-edit-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Alert informativo */}
              <div className="pt-2">
                <Alert variant="default" className="bg-info/5 border-info/30 rounded-xl">
