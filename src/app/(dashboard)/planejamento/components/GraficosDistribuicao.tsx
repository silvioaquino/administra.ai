    ...
    <div className="bg-surface rounded-2xl shadow-sm overflow-hidden">
      <div className="bg-surface-2 p-4 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-white">Distribuição % - {tipo === "almoco" ? "Almoço" : "Janta"}</h3>
        </div>
      </div>
      <div className="p-5">
        ...
        <div className="mt-5 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-bold text-primary">{formatPercentage(pctFixas)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">📈 Despesas Variáveis:</span>
            <span className="font-bold text-warning">{formatPercentage(despesasVariaveisPct)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">💰 Lucro:</span>
            <span className="font-bold text-success">{formatPercentage(lucroDesejado)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">🏭 CMV (Produção):</span>
            <span className="font-bold text-info">{cmvTexto}</span>
          </div>
        </div>
      </div>
    </div>
