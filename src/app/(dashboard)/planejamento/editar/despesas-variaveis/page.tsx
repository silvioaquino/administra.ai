...
import { ResultadosTaxas } from '@/app/(dashboard)/planejamento/components/ResultadosTaxas'
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-surface border-b border-border px-6 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">Configuração de Taxas</h1>
            <p className="text-sm text-muted-foreground">Maquininhas, distribuição e outras taxas</p>
          </div>
        </div>
        <Button
          onClick={salvarDados}
        ...
        <div className="bg-surface rounded-2xl shadow-sm overflow-hidden mb-6">
          <div className="bg-surface-2 p-4 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-white">Período de Referência</h3>
            </div>
          </div>
          <div className="p-5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-lg border border-border bg-surface px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary appearance-none pr-8"
                  >
          ...
          <div className="bg-surface-2 p-4 border-b border-border">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-white">Maquininhas</h3>
              </div>
              <Button
                variant="outline"
                size="sm"
                onClick={adicionarMaquininha}
                className="rounded-lg border-border hover:border-primary hover:bg-primary/5"
              >
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {maquininhas.length === 0 ? (
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm text-muted-foreground/70 mt-1">Clique em "Adicionar" para começar</p>
                </div>
              ) : (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-end gap-2">
                          ...
                          <Button
                            ...
                            className="text-destructive hover:text-destructive hover:bg-destructive/5 rounded-lg h-9 w-9 p-0"
                          >
        ...
        <div className="bg-surface rounded-2xl shadow-sm overflow-hidden mb-6">
          <div className="bg-surface-2 p-4 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-white">Distribuição de Vendas</h3>
            </div>
          </div>
          <div className="p-5">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Débito (%)</Label>
                <Input
                  type="number"
                  value={distribuicaoVendas.debito || ''}
                  onChange={e => setDistribuicaoVendas({ ...distribuicaoVendas, debito: parseFloat(e.target.value) || 0 })}
                  className="text-right font-mono text-lg font-bold rounded-lg border-border focus:ring-primary"
                  step="0.01"
                  min="0"
                />
              </div>
              <div className="space-y-1">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Crédito (%)</Label>
                <Input
                  type="number"
              ...
              <div className="space-y-1">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Voucher (%)</Label>
                <Input
                  type="number"
            ...
            <div className="flex justify-between items-center pt-4 mt-4 border-t border-border">
              ...
              <span className={`font-bold text-lg ${totalDistribuicao === 100 ? 'text-success' : 'text-destructive'}`}>
                {totalDistribuicao.toFixed(2)}%
                {totalDistribuicao !== 100 && (
                  <span className="text-xs font-normal text-destructive ml-2">(Deve ser 100%)</span>
                )}
              </span>
            </div>
          </div>
        ...
        <div className="bg-surface rounded-2xl shadow-sm overflow-hidden mb-6">
          <div className="bg-surface-2 p-4 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-semibold text-white">Outras Taxas</h3>
            </div>
          </div>
          <div className="p-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Simples Nacional (%)</Label>
                <Input
                  type="number"
              ...
              <div className="md:col-span-2 space-y-1">
                <Label className="text-xs font-medium text-muted-foreground uppercase tracking-wider">Manutenção (%)</Label>
                <Input
                  type="number"
