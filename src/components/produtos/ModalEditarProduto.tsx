// src/components/produtos/ModalEditarProduto.tsx
"use client"
...
export function ModalEditarProduto({ isOpen, onClose, produtoId, onSuccess }: ModalEditarProdutoProps) {
  ...
  return (
    <Modal
      ...
      subtitle={`Atualize as informações do produto #${formData.id}`}
      footer={
